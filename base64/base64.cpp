...
namespace ncbi
{
    ...
    const std :: string encodeBase64 ( const void * data, size_t bytes, unsigned int line_wrap )
    {
    ...
    {
        JWPayload payload = decodeBase64Impl ( encoding,
    ...
    const std :: string encodeBase64URL ( const void * data, size_t bytes, unsigned int line_wrap )
    {
